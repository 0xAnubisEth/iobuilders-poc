package com.roman.user.backend.config;
...
@Configuration
public class UserBackendServerConfiguration {
    private final RequestMappingHandlerMapping mapping;

    public UserBackendServerConfiguration(RequestMappingHandlerMapping mapping) {
