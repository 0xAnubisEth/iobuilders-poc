...
import com.roman.shared.infrastructure.bus.event.DomainEventSubscribersInformation;
import com.roman.shared.infrastructure.bus.event.DomainEventsInformation;
...
public class RabbitMqEventBusConfiguration {
    ...
    public RabbitMqEventBusConfiguration(
        ...
        this.config = config;
        this.exchangeName = config.getProperty("rabbitmq.exchange");
    }

    @Bean
    public CachingConnectionFactory connection() throws IllegalStateException {
        CachingConnectionFactory factory = new CachingConnectionFactory();

        factory.setHost(config.getRequiredProperty("rabbitmq.host"));
        factory.setPort(Integer.parseInt(config.getRequiredProperty("rabbitmq.port")));
        factory.setUsername(config.getRequiredProperty("rabbitmq.login"));
        factory.setPassword(config.getRequiredProperty("rabbitmq.password"));
